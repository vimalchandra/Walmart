...
public class Reusable_Functions {
	 ...
	 */
	public static void LaunchApplication(String browserName) throws InterruptedException
	{
	 ...
	 */
	public static void ValidateCartItem(Properties objects,WebElement z,String value,WebElement z1,String itemsincart)
	{
